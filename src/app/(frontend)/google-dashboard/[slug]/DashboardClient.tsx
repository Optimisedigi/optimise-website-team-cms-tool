    ...
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center px-4">
      ...
      <style>{`
        ...
        @keyframes rocketOffsetLoop {
          0% { transform: translateX(calc(-50% - 7.4px)) translateY(0); opacity: 0; }
          8% { transform: translateX(calc(-50% - 7.4px)) translateY(0); opacity: 1; }
          18% { transform: translateX(calc(-50% - 7.4px)) translateY(2px); opacity: 1; }
          32% { transform: translateX(calc(-50% - 7.4px)) translateY(-6px); opacity: 1; }
          78% { transform: translateX(calc(-50% - 7.4px)) translateY(-130px); opacity: 1; }
          92% { transform: translateX(calc(-50% - 7.4px)) translateY(-220px); opacity: 0; }
          100% { transform: translateX(calc(-50% - 7.4px)) translateY(-220px); opacity: 0; }
        }
        @keyframes flameLoop {
