...
import GoogleAdsAutomationPage from '../../../../components/GoogleAdsAutomationPage'
...
export default async function Page() {
  ...
  return (
    ...
    >
      <AdminStepNavSetter items={[{ label: 'Google Ads', url: '/admin/google-ads' }, { label: 'Automation Watchtower' }]} />
      <div className="gutter--left gutter--right" style={{ maxWidth: 1440 }}>
        <GoogleAdsAutomationPage />
      </div>
    </DefaultTemplate>
  )
}
