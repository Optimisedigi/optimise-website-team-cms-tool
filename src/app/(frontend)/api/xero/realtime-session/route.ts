...
export async function GET(): Promise<NextResponse> {
  try {
    ...
    const voiceGuardrail =
      ...
      "For overdue chase emails, preview first, then ask 'would you like to send this to Gmail Draft?' and only create Gmail drafts after a clear yes. Never send mail. " +
