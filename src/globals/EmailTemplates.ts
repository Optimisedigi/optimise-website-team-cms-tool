                ...
                },
                {
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      type: "textarea",
                      defaultValue: `Thanks for reaching out about Google Ads. We'll review your website first, then come back with the clearest next step for campaign setup, tracking and budget.`
                    },
                    {
                      ...
                      defaultValue: [
                        {
                          slug: "never-run-ads",
                          copy: `Because you haven't run Google Ads before, we'll focus on getting the foundations right before any budget goes live.`
                        },
                        {
                          slug: "tried-before",
                          copy: `Because Google Ads has been tried before, we'll look for what held it back before recommending a relaunch.`
                        },
                        {
                          slug: "starting-soon",
                          copy: `Because you're planning to start soon, we'll help you avoid launching with weak tracking, pages or campaign structure.`
                        },
                        {
                          slug: "relaunching",
                          copy: `Because you're looking at a relaunch, we'll review what should be rebuilt rather than just switching old campaigns back on.`
                        },
                      ],
                      fields: [
                    ...
                    },
                    {
                      ...
                      type: "array",
                      defaultValue: [
                        { slug: "more-phone-calls", copy: `We'll keep phone call quality front and centre.` },
                        { slug: "more-form-enquiries", copy: `We'll look at whether the site makes enquiries easy enough after the click.` },
                        { slug: "bookings-or-appointments", copy: `We'll consider the path from search to booking.` },
                        { slug: "local-service-leads", copy: `We'll pay close attention to service areas, intent and location targeting.` },
                        { slug: "sales-or-quotes", copy: `We'll build the recommendation around quote, demo or sales intent rather than clicks alone.` },
                      ],
                      fields: [
                        { name: "slug", label: "Answer Slug", type: "text", required: true },
                        { name: "copy", label: "Copy", type: "textarea", required: true },
                    ...
                    },
                    {
                      ...
                      type: "array",
                      defaultValue: [
                        { slug: "converts-well", copy: `If the site already converts well, we'll focus on tracking and high-intent traffic.` },
                        { slug: "needs-improvement", copy: `If the website needs improvement first, we'll flag the priority fixes before more budget goes to traffic.` },
                        { slug: "not-sure", copy: `If you're not sure how ready the site is, we'll give you a practical view on whether it can support paid traffic now.` },
                        { slug: "need-landing-page", copy: `If a landing page is needed, we'll outline what it should cover before campaigns launch.` },
                      ],
                      fields: [
                        { name: "slug", label: "Answer Slug", type: "text", required: true },
                        { name: "copy", label: "Copy", type: "textarea", required: true },
                    ...
                    },
                    {
                      ...
                      type: "array",
                      defaultValue: [
                        { slug: "under-1k", copy: `With a smaller budget, the account needs to stay focused.` },
                        { slug: "1k-2k", copy: `At that budget, we'd usually start with the highest-intent services and locations first.` },
                        { slug: "2k-5k", copy: `At that budget, there is room to test properly while keeping priorities clear.` },
                        { slug: "5k-plus", copy: `With that budget, tracking and structure need to be clean from day one.` },
                        { slug: "not-sure", copy: `If budget is still open, we'll suggest a realistic starting range after review.` },
                      ],
                      fields: [
                        { name: "slug", label: "Answer Slug", type: "text", required: true },
                        { name: "copy", label: "Copy", type: "textarea", required: true },
                    ...
                    },
                    {
                      ...
                      label: "Questions Intro",
                      type: "textarea",
                      defaultValue: `Two quick questions that would help us:`
                    },
                    {
                      ...
                      defaultValue: `We'll review what you've shared and come back with practical next steps.`
                    },
                  ],
                },
              ],
