...
describe('create_portfolio_budget_pacing_gmail_drafts', () => {
  ...
  it('uses completed-month data for both the summary and budget report', async () => {
    ...
    expect(draft.htmlBody).toContain('Berendsen spent $1,200 last month, generated 6 conversions, at a $200 CPA.')
    expect(draft.htmlBody).toContain('100 clicks from 2,000 impressions at a 5% CTR.')
