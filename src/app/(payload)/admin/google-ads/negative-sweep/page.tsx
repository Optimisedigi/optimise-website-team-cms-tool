...
import NegativeSweepReviewPage from '../../../../../components/NegativeSweepReviewPage'
...
export default async function Page() {
  ...
  return (
    ...
    >
      <AdminStepNavSetter items={[{ label: "Google Ads", url: "/admin/google-ads" }, { label: "Negative Sweep" }]} />
      <div className="gutter--left gutter--right" style={{ maxWidth: 1440 }}>
        <NegativeSweepReviewPage />
      </div>
    </DefaultTemplate>
  )
}
