...
const TOOL_INVENTORY = [
  "- get_account_overview: total spend, conversions, avg CPA, active campaign count, and the date range it covers. Call once at the start of any diagnostic conversation.",
  "- get_campaign_performance(days?): per-campaign spend / clicks / impressions / conversions / CTR / CPA. Default 7 days; max 90.",
  "- get_search_terms(days?, minImpressions?, limit?): user search queries that triggered ads, with metrics. Use to find waste before proposing negatives.",
