 ...
 * with this runId and renders them as a vertical timeline inside the Payload
...
export default async function AgentRunPage({
  ...
  if (!user) {
    redirect(`/admin/login?redirect=${encodeURIComponent(`/admin/agent-runs/${runId}`)}`);
  }
    ...
    return shell(
      <>
        ...
        <p style={{ marginTop: 24 }}>
          <a href="/admin/agent-approvals" style={{ color: "#2563eb" }}>
            ← Back to approvals
          </a>
        </p>
      </>,
  ...
  return shell(
    <>
      <div style={{ marginBottom: 12 }}>
        <a href="/admin/agent-approvals" style={{ fontSize: 12, color: "#2563eb", textDecoration: "none" }}>
          ← Approvals
        </a>
      </div>
