...
const PAGES = [
  {
    ...
    market: "AU",
    // Real data-track-section ids of the deployed market pages, in page order,
    // so local demo data exercises the dashboard's section map for real.
    sections: [
      { id: "hero", reach: 1.0, seconds: 9 },
      { id: "logostrip", reach: 0.93, seconds: 4 },
      { id: "compare", reach: 0.85, seconds: 24 },
      { id: "concerns", reach: 0.7, seconds: 18 },
      { id: "how", reach: 0.61, seconds: 22 },
      { id: "tools", reach: 0.52, seconds: 31 },
      { id: "sectors", reach: 0.45, seconds: 12 },
      { id: "why-vietnam", reach: 0.4, seconds: 16 },
      { id: "detail", reach: 0.34, seconds: 11 },
      { id: "approach", reach: 0.3, seconds: 14 },
      { id: "proof", reach: 0.27, seconds: 15 },
      { id: "faqs", reach: 0.22, seconds: 17 },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "logostrip", reach: 0.9, seconds: 3 },
      { id: "compare", reach: 0.78, seconds: 21 },
      { id: "concerns", reach: 0.6, seconds: 15 },
      { id: "how", reach: 0.5, seconds: 19 },
      { id: "tools", reach: 0.41, seconds: 26 },
      { id: "sectors", reach: 0.34, seconds: 10 },
      { id: "why-vietnam", reach: 0.29, seconds: 14 },
      { id: "approach", reach: 0.22, seconds: 12 },
      { id: "proof", reach: 0.19, seconds: 13 },
      { id: "faqs", reach: 0.15, seconds: 15 },
